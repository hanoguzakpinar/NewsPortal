                            ...
                            if (commentResult.Data) {
                                ...
                                $.each(commentResult.Data.Comments.$values,
                                    function (index, comment) {
                                        ...
                                        let newReport = getJsonNetObject(newComment.Report, newComment);
                                        if (newReport !== null) {
                                            reportsArray.push(newReport);
                                        }
                                        if (newReport === null) {
                                            newReport = reportsArray.find((report) => {
                                                return report.$id === newComment.Report.$ref;
                                            });
                                        }
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            `
                                <button class="btn btn-warning btn-sm btn-undo" data-id="${newComment.Id}"><span class="fa fa-undo"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete" data-id="${newComment.Id}"><span class="fa fa-minus-circle"></span></button>
                                            `
                                        ]).node();
